 ...
 * 
 */
@WebServiceClient(name = "ServerService", targetNamespace = "http://www.service.com", wsdlLocation = "http://127.0.0.1:8000/WebService?wsdl")
    ...
    extends Service
{
    ...
    private final static QName SERVERSERVICE_QNAME = new QName("http://www.service.com", "ServerService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://127.0.0.1:8000/WebService?wsdl");
    ...
    public WebService getServicePort() {
        return super.getPort(new QName("http://www.service.com", "servicePort"), WebService.class);
    }
     ...
     */
    @WebEndpoint(name = "servicePort")
    public WebService getServicePort(WebServiceFeature... features) {
        return super.getPort(new QName("http://www.service.com", "servicePort"), WebService.class, features);
    }
